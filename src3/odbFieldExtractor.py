...
#                             MAX_PRINCIPAL, MID_PRINCIPAL, MIN_PRINCIPAL]
tensorInvariants = ['MAX_INPLANE_PRINCIPAL', 'MAX_PRINCIPAL']
tensorInvariantConstants = [MAX_INPLANE_PRINCIPAL, MAX_PRINCIPAL]
...
def extractFieldData(odb, frameList, fieldList):
    ...
    log(0,"odbFieldExtractor", "Extracting at most {0} fields per frame".format(len(fieldList)))
    ...
    for i, frame in enumerate(frameList):
        ...
        #logList("frame.fieldOutputs.keys()", frame.fieldOutputs.keys())
